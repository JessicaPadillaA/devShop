        ...
        <div className="details">
            ...
            {allDresses.map((dress) => (
                (dress.prodCode === prodCodeLocal) ? (
                    <div className="details__product" key={dress.prodCode}>
                        <div className="details__product__image">
                            <img src={dress.imagePath} alt="Imagen" className="details__product__img" />
                        </div>
                        <div className="details__product__info">
                            <h3 className="details__product__name">Producto: {dress.prodName}</h3>
                            <h3 className="details__product__description">Descripción: {dress.description}</h3>
                            <h3 className="details__product__size">Talla: {dress.size}</h3>
                            <h3 className="details__product__price">Precio: ${dress.price}</h3>
                            <h3 className="details__product__brand">Marca: {dress.brand}</h3>
                            <h3 className="details__product__local-stock">Disponibles: {prodStockLocal}</h3>
                        </div>
